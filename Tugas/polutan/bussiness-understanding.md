...
Kabupaten Jombang merupakan salah satu wilayah yang berkembang di Jawa Timur dengan perpaduan kawasan perkotaan, permukiman, lahan pertanian, kawasan industri, dan jaringan jalan yang menghubungkan berbagai daerah. Salah satu wilayah yang menjadi fokus proyek ini adalah Kecamatan Bandarkedungmulyo. Aktivitas transportasi, permukiman, pertanian, dan kegiatan ekonomi di kecamatan tersebut berpotensi menimbulkan variasi emisi dari satu waktu ke waktu lainnya. Karena itu, kondisi kualitas udara di Bandarkedungmulyo perlu dipahami melalui pengamatan berkala menggunakan data yang dapat menggambarkan perubahan atmosfer di wilayah tersebut.

Dalam proyek ini, data pengamatan dari satelit **Copernicus Sentinel-5P** digunakan untuk mengamati perubahan relatif konsentrasi gas polutan di Kecamatan Bandarkedungmulyo, Kabupaten Jombang. Data tersebut diambil melalui _Copernicus Data Space Ecosystem_ menggunakan area pengamatan berbentuk poligon, kemudian diproses menjadi data tabular berbentuk deret waktu (_Time Series_). Dataset hasil crawling mencakup pengamatan sekitar satu tahun pada periode 2025–2026. Pendekatan ini memungkinkan analisis dilakukan secara lebih terstruktur untuk melihat pola harian, kecenderungan perubahan, dan periode ketika konsentrasi polutan mengalami peningkatan.

Wilayah analisis ditentukan menggunakan koordinat _Area of Interest_ (AOI) yang mewakili Kecamatan Bandarkedungmulyo. Nilai pada beberapa piksel di dalam AOI diringkas menggunakan rata-rata sehingga setiap tanggal menghasilkan satu nilai polutan. Dengan cara ini, fokus analisis berada pada perubahan waktu di wilayah penelitian, bukan pada perbandingan detail antar-piksel.
...
- Bagaimana perubahan dan tren konsentrasi harian gas polutan (CO, SO₂, dan NO₂) di Kecamatan Bandarkedungmulyo?
- Apakah terdapat pola berulang, kecenderungan peningkatan atau penurunan selama periode pengamatan, maupun lonjakan (anomali) mendadak pada tingkat polusi udara di wilayah tersebut?
...
- Menentukan dan menggunakan Kecamatan Bandarkedungmulyo sebagai wilayah pengamatan secara konsisten pada setiap tahap pengolahan data.
...
- Menyediakan dasar data historis yang terdokumentasi untuk keperluan analisis prediktif (_forecasting_) kualitas udara di Kecamatan Bandarkedungmulyo pada masa mendatang.
...
- **Masyarakat Kecamatan Bandarkedungmulyo:** Menjadi sumber informasi yang lebih transparan mengenai perubahan kualitas udara di wilayah sekitar dan meningkatkan kesadaran terhadap aktivitas yang dapat menghasilkan emisi.
